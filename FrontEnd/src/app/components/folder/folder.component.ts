...
export class FolderComponent implements OnInit {
  ...
  constructor(private _carpetaService:CarpetaService,private _proyectoService:ProyectoService,private _snippetService:SnippetService, private activatedRoute: ActivatedRoute, private _router: Router) { 
  ...
  verProyecto(carpeta:string,nombre:string, id:String){
    this._router.navigate(['/develop',carpeta, nombre, id]);
  }
